...
export default function ChatScreen() {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: "#FFF7FD" }}>
            <LinearGradient colors={["#FFD7F8", "#FFF7FD"]} style={{ flex: 1 }}>
                {/* ── HEADER ── */}
                <View
                    style={{
                        flexDirection: "row",
                ...
                >
                    ...
                    >
                        <Ionicons name="arrow-back" size={24} color="#7A2BE2" />
                    </TouchableOpacity>
                    ...
                    <View style={{ position: "relative" }}>
                        {friendImage ? (
                            ...
                            >
                                <FontAwesome name="user" size={20} color="#7A2BE2" />
                            </View>
                        )}
                        <View
                            style={{
                            ...
                            renderItem={({ item }) => {
                                ...
                                return (
                                    ...
                                    >
                                        <View
                                            style={{
                                                backgroundColor: isMe ? "#7A2BE2" : "#FFFFFF",
                                                paddingHorizontal: 16,
                                                paddingVertical: 10,
                                                borderRadius: 20,
                    ...
                    >
                        ...
                        <TouchableOpacity
                            ...
                            style={{
                                ...
                                height: 44,
                                borderRadius: 22,
                                backgroundColor: text.trim() ? "#7A2BE2" : "#D4B4F5",
                                justifyContent: "center",
                                alignItems: "center",
                                marginLeft: 10,
                            }}
