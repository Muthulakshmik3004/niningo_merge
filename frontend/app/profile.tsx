  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Remember who's logged in on this device so the tab pages
        // (All/Unread/Pending/Groups) and Moments/Status page know
        // whose data to load from the database.
        await saveSession({ username: cleanUsername, name: name.trim(), profileImage: image });
        router.push({ pathname: "/location", params: { username: cleanUsername } });
      } else {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text className="text-[36px] font-bold text-center mt-[40px]">Create Your Profile</Text>
        ...
        >
          ...
          <Text className="font-bold text-[18px] mb-[6px] mt-[10px]">Name</Text>
          ...
          <Text className="font-bold text-[18px] mb-[6px] mt-[10px]">Username</Text>
          ...
          <Text className="font-bold text-[18px] mb-[6px] mt-[10px]">Bio</Text>
