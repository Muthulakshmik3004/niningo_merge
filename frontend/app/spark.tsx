      ...
      <LinearGradient colors={theme.gradient} style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            ...
            {/* Missions */}
            <Text style={[styles.missionsTitle, { color: theme.primary }]}>
              Missions
            </Text>
            ...
            {/* Calendar */}
            <View style={[styles.calendarContainer, { backgroundColor: "#FFFFFFEE", borderWidth: 1, borderColor: theme.primary + "33" }]}>
              {/* Calendar Header */}
              <View style={styles.calendarHeader}>
                ...
                >
                  <Text style={[styles.yearText, { color: theme.primary }]}>
                    {selectedYear}
                  </Text>
